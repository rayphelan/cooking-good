      ...
      <div class="container g-py-100 ">
        <div class="u-shadow-v19 g-max-width-645 g-brd-around g-brd-gray-light-v4 text-center rounded mx-auto g-pa-30 g-pa-50--md">
          <div class="mb-5">
            ...
            <p>Please insert your email address and we'll send you a link to reset your password.</p>            
          </div>
          

              <!-- Form -->
              <form id="resetPWForm" method="post" action="<?php print base_url($lg."/resetpassword/submit");?>" class="g-py-15">
                <div class="mb-4">
                ...
                <div class="mb-1">
                  <button id="resetPWButton" class="submit-button btn btn-block u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" type="button">Send recovery link</button>
                </div>
      ...
      <div class="container g-py-100 ">
        <div class="u-shadow-v19 g-max-width-645 g-brd-around g-brd-gray-light-v4 text-center rounded mx-auto g-pa-30 g-pa-50--md">
          ...
          <div class="mb-5">
            ...
            <p>We have sent you an email with a link to reset your password. Please note that it will only be valid for 24 hours.</p>            
          </div>
          <a class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" href="<?php print base_url($lg."/login");?>">Continue</a>
        </div>
      </div>
    </div>
    <!-- End Thank you message -->
