<div id="selected-recipes" class="container g-py-100">
        <!-- Heading -->
        <div class="g-max-width-550 text-center mx-auto g-mb-70">
          <h2 class="text-uppercase g-color-main-light-v1 g-font-weight-600 g-font-size-13 g-letter-spacing-2 mb-4">Highlights</h2>
          <h2 class="h3 mb-5">These are our favorite recipes from last week</h2>
        </div>
        <!-- End Heading -->
        ...
        <ul id="filterControls" class="d-block list-inline text-center g-mb-50">
          ...
          <li class="list-inline-item cbp-filter-item g-brd-around g-brd-secondary-light-v2 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-13 g-rounded-30 g-transition-0_3 g-px-20 g-py-7 mb-2" role="button"
              data-filter=".meat">Meat
          </li>
          <li class="list-inline-item cbp-filter-item g-brd-around g-brd-secondary-light-v2 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-13 g-rounded-30 g-transition-0_3 g-px-20 g-py-7 mb-2" role="button"
              data-filter=".fish">Fish
          </li>
          <li class="list-inline-item cbp-filter-item g-brd-around g-brd-secondary-light-v2 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-13 g-rounded-30 g-transition-0_3 g-px-20 g-py-7 mb-2" role="button"
              data-filter=".snacks">Snacks
          </li>
        </ul>
        ...
        <div class="cbp g-mb-50"
          ...
          <div class="cbp-item fish">
            <div class="u-block-hover g-parent">
              <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="<?php print base_url('assets/images/recipes/1.jpg');?>" alt="Seafood pasta">
              <div class="d-flex w-100 h-100 g-bg-primary-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                  ...
                  <li class="list-inline-item">
                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle" href="<?php print base_url('assets/images/recipes/1.jpg');?>">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Seafood Pasta</h3>
              <p class="mb-0">Diana Phelan, Ireland</p>
            </div>
          </div>
          ...
          */ ?>
          ...
          <div class="cbp-item meat">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Grilled Chicken</h3>
              <p class="mb-0">Lucas Perico, Portugal</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          ...
          <div class="cbp-item fish">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Grilled Salmon</h3>
              <p class="mb-0">Tamiya June, Ireland</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          ...
          <div class="cbp-item meat">
            <div class="u-block-hover g-parent">
              <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="<?php print base_url('assets/images/recipes/4.jpg');?>" alt="Beef with Gravy">
              <div class="d-flex w-100 h-100 g-bg-primary-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                  <li class="list-inline-item">
                    <a class="u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle" href="#!">
                  ...
                  <li class="list-inline-item">
                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle" href="<?php print base_url('assets/images/recipes/4.jpg');?>">
                      <i class="icon-communication-017 u-line-icon-pro"></i>
                    </a>
                  </li>
                </ul>
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Beef with Gravy</h3>
              <p class="mb-0">Nyasha Sineti, Zimbabwe</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          */ ?>
          ...
          <div class="cbp-item fish">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Canapes</h3>
              <p class="mb-0">Roberto, Itally</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          ...
          <?php /*
          <!-- Cube Portfolio Blocks - Item -->
          <div class="cbp-item snacks">
            <div class="u-block-hover g-parent">
              <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="<?php print base_url('assets/images/recipes/6.jpg');?>" alt="Finger Food">
              <div class="d-flex w-100 h-100 g-bg-primary-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                  <li class="list-inline-item">
                    <a class="u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle" href="#!">
                  ...
                  <li class="list-inline-item">
                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle" href="<?php print base_url('assets/images/recipes/6.jpg');?>">
                      <i class="icon-communication-017 u-line-icon-pro"></i>
                    </a>
                  </li>
                </ul>
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Finger Food</h3>
              <p class="mb-0">Arriana, Itally</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          */ ?>
          ...
          <div class="cbp-item snacks">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Munchies</h3>
              <p class="mb-0">June, Spain</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          ...
          <div class="cbp-item meat">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Meat</h3>
              <p class="mb-0">Kevin, Ireland</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->     
          ...
          <div class="cbp-item meat">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Roast Beef</h3>
              <p class="mb-0">Heather, Portugal</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->               
          ...
          <div class="cbp-item fish">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">King Prawns</h3>
              <p class="mb-0">Dephine, U.K.</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
          ...
          <div class="cbp-item snacks">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Fruit Salad</h3>
              <p class="mb-0">Luis, Portugal</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->          
          ...
          <div class="cbp-item snacks">
            ...
            <div class="text-center g-pa-25 mb-1">
              <h3 class="h5 g-font-weight-600 mb-1">Eggs</h3>
              <p class="mb-0">Diana Phelan, Ireland</p>
            </div>
          </div>
          <!-- End Cube Portfolio Blocks - Item -->
